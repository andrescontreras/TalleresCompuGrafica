...
void planeta2()
{
  ...
  glRotatef(40, 0, 1, 0);
  //Elipse de tamaño 6 en x y 8 en y
  glTranslatef(6 * std::cos(tra4+17), 0, 8 * std::sin(tra4+17));
...
void planeta3()
{
  ...
  glTranslatef(0, -1.5, 0);
  glRotatef(90, 0, 1, 1);
  glTranslatef(9 * std::cos(tra6+40), 0, 12 * std::sin(tra6+40));
  glRotatef(30, 1, 1, -1);
  glRotatef(rot1, 0, 1, 0);
  glScalef(1, 1.4, 1.4);
...
void planeta5()
{
  ...
  //Figura de tamaño 1.5
  glScalef(1, 1, 1.8);
  DrawUnitaryCube(GL_POLYGON, 0, 2, 5);
  DrawUnitaryCube(GL_LINE_LOOP, 0, 2, 2);
  glPopMatrix();
  //Lunas
  //Anillo Luna 1
  glPushMatrix();
...
void planeta6()
{
  ...
  glRotatef(ra, rx, ry, rz);
  //Elipse de tamaño 6 en x y 8 en y
  glTranslatef(6 * std::cos(tra4-14), 0, 8 * std::sin(tra4-14));
  //Se Regresa a la rotación inicial
  glRotatef(40, 0, -1, 0);
  //Se rotan 45° en x , y
  glRotatef(45, 1, 1, 0);
  ...
  //Figura de tamaño 1.5
  glScalef(1, 0.5, 1.5);
  DrawUnitaryPyramid(GL_POLYGON, 6, 6, 1);
  DrawUnitaryPyramid(GL_LINE_LOOP, 1, 1, 1);
  glPopMatrix();
  //Lunas
  //Anillo Luna 1
...
void planeta7()
{
  ...
  //Figura de tamaño 1.5
  glScalef(2, 4, 0.5);
  DrawUnitaryOctahedron(GL_POLYGON, 0, 1, 0);
  DrawUnitaryOctahedron(GL_LINE_LOOP, 0, 1, 0);
  glPopMatrix();
  //Lunas
  //Anillo Luna 1
  glPushMatrix();
